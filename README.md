...
- [HealthClaw Guardrails](https://github.com/aks129/HealthClawGuardrails) - Guardrail layer between AI agents and any FHIR server with 24 tools behind PHI redaction, immutable AuditEvent trail, HMAC step-up authorization, human-in-the-loop write gates, and tenant isolation; includes HL7 SDC form population/extraction, an NQF 0018 measure calculator, lab reference-range interpretation, and OpenAI/Gemini adapters (`TypeScript`).
